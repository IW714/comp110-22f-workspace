...
# An example of a tuple wthout type aliasing
goat: tuple[str, int] = ("MJ", 23)

# Tuples are ssequences, so they're 0-indexed
print(goat[0])
print(goat[1])
...
# Meaing you can loop over them iwth for...in
for item in goat:
    print(item)

# Tuples, unlikes lists, are immutable
# Which means we cannot reasssing items, nor append, nor pop, etc.
# goat[0] = "LBJ"
